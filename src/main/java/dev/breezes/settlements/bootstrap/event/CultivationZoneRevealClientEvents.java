...
public final class CultivationZoneRevealClientEvents {
    ...
    public static void onRenderLevelStage(@Nonnull RenderLevelStageEvent event) {
        ...
        clientComponent.cultivationLilyZoneRevealRenderer().render(event);
        clientComponent.cultivationLilyPlacementPreviewRenderer().render(event);
    }
