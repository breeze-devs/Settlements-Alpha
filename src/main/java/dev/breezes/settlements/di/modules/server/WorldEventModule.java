...
/**
 * Declares the {@link dev.breezes.settlements.domain.ai.worldevent.WorldEventBus} and
 * {@link dev.breezes.settlements.bootstrap.event.WorldEventBusReaperServerEvents}
 * for Dagger auto-provisioning.
 * <p>
 * Both classes carry {@code @ServerScope} and {@code @Inject} constructors, so no
