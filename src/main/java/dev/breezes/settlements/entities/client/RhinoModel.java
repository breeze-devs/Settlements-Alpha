...
import dev.breezes.settlements.entities.animations.ModAnimationDefinition;
...
public class RhinoModel<T extends Entity> extends HierarchicalModel<T> {
    ...
    public RhinoModel(ModelPart root) {
        ...
        this.head = this.rhino.getChild("body").getChild("torso").getChild("head");
    }
    ...
    public void setupAnim(T entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        this.animateWalk(ModAnimationDefinition.RHINO_WALK, limbSwing, limbSwingAmount, 2, 3F);
        this.animate(rhino.idleAnimationState, ModAnimationDefinition.RHINO_IDLE, ageInTicks, 1);
        this.animate(rhino.attackAnimationState, ModAnimationDefinition.RHINO_ATTACK, ageInTicks, 4);
    }
