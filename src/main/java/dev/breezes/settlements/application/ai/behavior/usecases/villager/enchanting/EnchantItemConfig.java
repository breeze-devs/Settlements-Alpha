...
@BehaviorConfig(name = "enchant_item", type = ConfigurationType.BEHAVIOR)
public record EnchantItemConfig(
        ...
        @IntegerConfig(
                ...
                description = "Horizontal range (in blocks) to scan for nearby enchanting tables.",
                defaultValue = 16,
                min = 5,
                max = 64)
        ...
        @IntegerConfig(
                ...
                description = "Vertical range (in blocks) to scan for nearby enchanting tables.",
                defaultValue = 4,
                min = 1,
                max = 16)
