...
@BehaviorConfig(name = "ring_bell", type = ConfigurationType.BEHAVIOR)
public record RingBellConfig(
        @IntegerConfig(
        ...
        @IntegerConfig(
                ...
                description = "Horizontal range (in blocks) to scan for nearby bells.",
                defaultValue = 16,
                min = 5,
                max = 64)
        ...
        @IntegerConfig(
                ...
                description = "Vertical range (in blocks) to scan for nearby bells.",
                defaultValue = 4,
                min = 1,
                max = 16)
