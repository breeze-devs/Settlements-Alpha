...
import dev.breezes.settlements.domain.ai.sensors.INearbySensor;
import dev.breezes.settlements.infrastructure.minecraft.entities.villager.BaseVillager;
import dev.breezes.settlements.domain.ai.conditions.IEntityCondition;
import dev.breezes.settlements.domain.ai.memory.MemoryTypeRegistry;
import dev.breezes.settlements.domain.ai.memory.entry.MemoryEntry;
import dev.breezes.settlements.domain.time.ITickable;
import dev.breezes.settlements.domain.ai.sensors.result.EmptySenseResultEntry;
import dev.breezes.settlements.domain.ai.sensors.result.ISenseResult;
import dev.breezes.settlements.domain.ai.sensors.result.ISenseResultEntry;
import dev.breezes.settlements.domain.ai.sensors.result.SenseResultEntry;
