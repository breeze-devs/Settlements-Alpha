...
@BehaviorConfig(name = "wash_wolf", type = ConfigurationType.BEHAVIOR)
public record WashWolfConfig(
        @IntegerConfig(
        ...
        @IntegerConfig(
                ...
                description = "Horizontal range (in blocks) to scan for owned dirty wolves",
                defaultValue = 32,
                min = 5,
                max = 128)
        ...
        @IntegerConfig(
                ...
                description = "Vertical range (in blocks) to scan for owned dirty wolves",
                defaultValue = 12,
                min = 1,
                max = 16)
