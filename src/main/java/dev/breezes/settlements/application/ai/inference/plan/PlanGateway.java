...
/**
 * Capability seam for generating LLM day-plan overlays.
 */
public interface PlanGateway {

    /**
     * Starts a streaming plan request and invokes {@code onVillager} each time a complete
     ...
     *
     * @param request    batch payload describing all villagers, their menus, and windows
     ...
     */
    InferenceStreamHandle generate(PlanBatchRequest request, Duration deadline, Consumer<VillagerPlanResult> onVillager);
