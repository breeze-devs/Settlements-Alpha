...
@BehaviorConfig(name = "harvest_sweet_berries", type = ConfigurationType.BEHAVIOR)
public record HarvestSweetBerriesConfig(
        ...
        @IntegerConfig(
                ...
                description = "Horizontal range (in blocks) to scan for nearby ripe sweet berry bushes",
                defaultValue = 16,
                min = 1,
                max = 32)
        ...
        @IntegerConfig(
                ...
                description = "Vertical range (in blocks) to scan for nearby ripe sweet berry bushes",
                defaultValue = 4,
                min = 0,
                max = 8)
        ...
        @FloatConfig(
                ...
                description = "Movement speed multiplier while navigating to a sweet berry bush",
                defaultValue = 0.5f,
                min = 0.1f,
                max = 1.5f)
        float movementSpeed,
        ...
        @IntegerConfig(
                ...
                description = "Maximum ticks allowed for the villager to reach a bush before re-targeting (20 ticks = 1 second)",
                defaultValue = 400,
                min = 20,
                max = 2000)
    ...
    public HarvestSweetBerriesConfig {
