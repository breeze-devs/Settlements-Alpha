...
/**
 * Configuration for the Investigate behavior.
 * <p>
 * Investigate is triggered either by the heuristic planner (unverified tip matching a blocked goal)
 * or by the override lane (tip unblocking a starved need). The cooldowns here govern the planner
 * slot spacing; the override path bypasses cooldowns by construction.
 */
@BehaviorConfig(name = "investigate", type = ConfigurationType.BEHAVIOR)
public record InvestigateConfig(
