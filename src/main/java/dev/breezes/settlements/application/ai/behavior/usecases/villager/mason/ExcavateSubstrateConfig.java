...
@BehaviorConfig(name = "excavate_substrate", type = ConfigurationType.BEHAVIOR)
public record ExcavateSubstrateConfig(
        @IntegerConfig(
        ...
        @MapConfig(
                ...
                description = "Map of villager expertise level to the maximum number of loose-ground shovel digs in one session.",
    ...
    public ExcavateSubstrateConfig {
